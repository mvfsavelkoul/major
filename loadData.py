from dataReader2014 import read_data_2014
...
def loadDataAndEmbeddings(config,loadData):
    ...
    if loadData == True:
        ...
        train_data = read_data_2014(FLAGS.train_data, source_count, source_word2idx, target_count, target_phrase2idx, FLAGS.train_path)
        print('reading test data...')
        test_data = read_data_2014(FLAGS.test_data, source_count, source_word2idx, target_count, target_phrase2idx, FLAGS.test_path)
